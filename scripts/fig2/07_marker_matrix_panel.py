...
LEAF_FILE = DATA / "GCMS_leaf.csv"

df = pd.read_csv(LEAF_FILE)
...
key_vocs = ["D-Limonene", "α-Terpineol"]

print("\n>>> [Step2] 使用 VOC：", key_vocs)
...
for voc in key_vocs:
    ...
    for s, z in zip(sizes_legend, z_legend):
        ...
        h = ax.scatter([], [], s=s, color="white", edgecolors="black",
